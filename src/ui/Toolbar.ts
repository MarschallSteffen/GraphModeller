...
const ICONS: Record<Tool, string> = {
  ...
  'uc-system':   `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="1"/><rect x="3" y="3" width="8" height="5" rx="1" fill="currentColor" stroke="none"/></svg>`,
