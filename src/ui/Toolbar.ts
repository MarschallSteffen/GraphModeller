...
const ICONS: Record<Tool, string> = {
  ...
  pan:           `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M18 11V6a2 2 0 0 0-4 0v5"/><path d="M14 10V4a2 2 0 0 0-4 0v6"/><path d="M10 10V5a2 2 0 0 0-4 0v9"/><path d="M22 11a2 2 0 0 0-4 0v1"/><path d="M6 14c0 0 0 7 6 7s6-3 6-3l2-4"/></svg>`,
  ...
  package:       `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="8" width="18" height="13" rx="1.5"/><path d="M3 8 L3 5 Q3 3 5 3 L9 3 Q11 3 11 5 L11 8" fill="none"/></svg>`,
  ...
  agent:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="6" width="18" height="12" rx="2"/><circle cx="9" cy="12" r="2" stroke-width="1.5"/><path d="M14 10h4 M14 14h4" stroke-width="1.5" stroke-linecap="round"/></svg>`,
